...
## During the project:
- Developed a desktop application for an organization to automate the papar work using Python & Tkinter & Xlwings. - - Collaborated with `@Alimov-8` to create a GUI part and backend.  
